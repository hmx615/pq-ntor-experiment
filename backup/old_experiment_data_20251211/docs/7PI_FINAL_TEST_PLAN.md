...
基于师妹研究的LEO卫星+UAV+地面NOMA协作网络，12个拓扑涵盖：

| 网络类型 | 延迟范围 | 带宽范围 | 丢包率 | 说明 |
|---------|---------|---------|--------|------|
| **卫星上/下行** | 2.7-5.5ms | 8-32 Mbps | 0.1-2.0% | LEO低轨卫星 |
| **UAV中继** | 0.004-0.02ms | 14-29 Mbps | 0.1-2.0% | 空基中继 |
| **D2D协作** | 0.002-0.003ms | 3.6-8.8 Mbps | 0.1-2.0% | 地面协作 |
| **NOMA混合** | 2.7-5.5ms | 3.6-32 Mbps | 0.1-2.0% | 复杂协作拓扑 |
...
| 拓扑ID | 场景 | 带宽 | 延迟 | 丢包率 | 测试次数 | 说明 |
|--------|------|------|------|--------|---------|------|
| 1 | Z1 Up - 直连NOMA | 31.81 Mbps | 5.42ms | 2.0% | 100 | SAT←S2(地面)+S1(UAV) |
| 2 | Z1 Up - T协作接入 | 8.77 Mbps | 5.44ms | 2.0% | 100 | T通过双路径上行 |
| 3 | Z3 Up - T用户协作NOMA | 20.53 Mbps | 2.73ms | 0.1% | 100 | 两地面T经UAV中继 |
| 4 | Z4 Up - 混合直连+协作 | 29.21 Mbps | 5.42ms | 2.0% | 100 | S2直连+T经UAV |
| 5 | Z5 Up - 多层树形结构 | 23.03 Mbps | 5.43ms | 2.0% | 100 | S2直连+T1/T2经UAV |
| 6 | Z6 Up - 双UAV中继 | 29.21 Mbps | 5.42ms | 0.1% | 100 | 两UAV分别中继T用户 |

**下行拓扑 (Downlink 7-12)**：

| 拓扑ID | 场景 | 带宽 | 延迟 | 丢包率 | 测试次数 | 说明 |
|--------|------|------|------|--------|---------|------|
| 7 | Z1 Down - 直连NOMA+协作 | 14.08 Mbps | 5.44ms | 2.0% | 100 | SAT→S1(UAV)+S2(地面) |
| 8 | Z2 Down - 多跳协作下行 | 8.77 Mbps | 5.46ms | 2.0% | 100 | SAT→S1/S2→T(地面) |
| 9 | Z3 Down - T用户协作下行 | 8.77 Mbps | 2.72ms | 0.5% | 100 | SAT→UAV→T1+T2协作 |
| 10 | Z4 Down - 混合直连+单跳 | 8.77 Mbps | 5.44ms | 2.0% | 100 | SAT→S1+S2/R→T |
| 11 | Z5 Down - 混合+多跳协作 | 3.6 Mbps | 5.44ms | 2.0% | 100 | SAT→S1+S2/R→T1/T2 |
| 12 | Z6 Down - 双中继协作 | 8.77 Mbps | 5.44ms | 2.0% | 100 | SAT→S1/S2→T1/T2 |

**拓扑特点**：
- 所有拓扑基于 **LEO低轨卫星**（延迟~2.7ms）
- 包含 **UAV空基中继**、**地面D2D协作**
- 复杂的 **NOMA非正交多址** 协作场景
- 端到端延迟 2.72-5.46ms（非简化参数）
- 带宽范围 3.6-31.81 Mbps（真实计算值）
