#!/bin/bash
# 启动正确版本（frontend，带完整功能）

echo "========================================"
echo "启动 PQ-NTOR SAGIN 演示系统"
echo "完整版本（时间、图例、协作NOMA链路）"
echo "========================================"
echo ""
...
# 启动前端 - 使用正确的 frontend 目录，绑定到 0.0.0.0
echo "启动前端（完整版本）..."
cd ../frontend
...
for ip in $(hostname -I); do
    echo "  控制面板: http://$ip:8080/control-panel/"
done
echo ""

echo "功能特性："
echo "  ✅ 左上角实时时间显示"
echo "  ✅ 左下角链路图例（绿色/橙色/紫色）"
echo "  ✅ 12个拓扑完整支持"
echo "  ✅ Topo 7-12 显示紫色协作NOMA链路"
echo ""
