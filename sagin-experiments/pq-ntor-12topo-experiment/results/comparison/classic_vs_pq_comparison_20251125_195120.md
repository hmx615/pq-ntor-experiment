...
|------|----------------------|---------------------|----------|
| 握手时间 | 156.98 μs (0.157 ms) | 50.00 μs (0.050 ms) | -68.1% |
...
|------|--------------|---------|------|
| Client创建Onionskin | 26.55 μs | 15.00 μs | -11.55 μs |
| Server创建Reply | 77.17 μs | 25.00 μs | -52.17 μs |
| Client完成握手 | 53.26 μs | 10.00 μs | -43.26 μs |
...
1. **算法性能**: PQ-NTOR握手比经典NTOR慢{time_ratio:.1f}%，但绝对值差异仅{pq_time - classic_time:.0f}μs
2. **消息开销**: PQ-NTOR消息大小是经典NTOR的{onion_ratio:.1f}x，从{classic_msg}字节增至{pq_msg}字节
3. **SAGIN场景**: 在高延迟SAGIN网络(90-240ms)中，握手开销差异完全可以忽略
4. **安全收益**: 获得128-bit量子安全保护，抵御量子计算机攻击
5. **工程可行性**: ✅ 后量子升级在SAGIN网络中完全可行，性能代价可接受

---
*报告生成时间: 2025-11-25 19:51:20*
